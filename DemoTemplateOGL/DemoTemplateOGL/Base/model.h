...
public:
    ...
    virtual void setScale(glm::vec3* scale, int idx = 0);
    virtual void setRotX(float rotationAngle, int idx = 0);
    virtual void setRotY(float rotationAngle, int idx = 0);
    virtual void setRotZ(float rotationAngle, int idx = 0);
    virtual glm::vec3* getTranslate(int idx = 0);
    virtual glm::vec3* getNextTranslate(int idx = 0);
    virtual glm::vec3* getScale(int idx = 0);
    virtual float getRotX(int idx = 0);
    virtual float getRotY(int idx = 0);
    virtual float getRotZ(int idx = 0);
    glm::vec3* getRotationVector(int idx = 0);
    virtual float getNextRotX(int idx = 0);
    virtual float getNextRotY(int idx = 0);
    virtual float getNextRotZ(int idx = 0);
    glm::vec3* getNextRotationVector(int idx = 0);
    bool getActive(int idx = 0);
    virtual void setNextRotX(float rotationAngle, int idx = 0);
    virtual void setNextRotY(float rotationAngle, int idx = 0);
    virtual void setNextRotZ(float rotationAngle, int idx = 0);
